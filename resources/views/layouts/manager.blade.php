...
<body class="d-flex flex-column min-vh-100 bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success mb-4">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('manger.dashboard') }}">
                Employee Dashboard
            </a>
            ...
            <div class="collapse navbar-collapse" id="employeeNavbar">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('manger.dashboard') }}">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('task.all') }}">All Task</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('alluser') }}">All User</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('project.all') }}">All Project</a>
                    </li>
                    <li class="nav-item">
