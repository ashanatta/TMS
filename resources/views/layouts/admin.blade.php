        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="employeeNavbar">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('assigne.all') }}">All Assigne</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('project.all') }}">All Projects</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('alluser') }}">All Users</a>
                    </li>
                    <li class="nav-item">
